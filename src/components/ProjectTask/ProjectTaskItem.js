...
class ProjectTaskItem extends Component {
  onDeleteClick(projectTaskId, projectId) {
    this.props.deleteProjectTask(projectTaskId, projectId);
  }
  ...
  render() {
    ...
    return (
      <div className="card mb-1 bg-light">
        <div className="card-header text-primary">Project: {project_task.projectId}</div>
        ...
        <div className="card-body bg-light">
          ...
          <button className="btn btn-danger ml-4" onClick={this.onDeleteClick.bind(this, project_task.id, project_task.projectId)}>Delete</button>
        </div>
      </div>
    );
  }
